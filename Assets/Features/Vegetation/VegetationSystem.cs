...
public class VegetationSystem : MonoBehaviour {
	...
	public void Rebuild() {
		...
		UnityEngine.Profiling.Profiler.BeginSample("Sorting Setup");
		CreateSortingStructures();
		UnityEngine.Profiling.Profiler.EndSample();
		
		UnityEngine.Profiling.Profiler.BeginSample("Indirect Setup");
		...
		UnityEngine.Profiling.Profiler.BeginSample("Rendering Setup");
		SetupRenderObjects();
		UnityEngine.Profiling.Profiler.EndSample();
	...
	void CreateSortingStructures() {
		UnityEngine.Profiling.Profiler.BeginSample("Sorting structures");
...
if(false) {
	...
	void SortPatches(Vector3 point) {
		...
		UnityEngine.Profiling.Profiler.BeginSample("Vegetation Sort Patches");
		...
		for(int i = 0, n = m_slimCells.Length; i < n; ++i) {
			...
			if(slimCell.sector != sector && slimCell.mesh && slimCell.sindices != null) {
				UnityEngine.Profiling.Profiler.BeginSample("Reordering cell");
	...
	void SortCells(Vector3 point, Plane[] cullPlanes) {
		UnityEngine.Profiling.Profiler.BeginSample("Vegetation Sort Cells");
