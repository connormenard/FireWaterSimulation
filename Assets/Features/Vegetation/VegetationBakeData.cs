...
public class VegetationBakeData : MonoBehaviour {
	...
	public void BakeVegetation() {
		...
		UnityEngine.Profiling.Profiler.BeginSample("Cell Setup");
	...
	void CreateCellCandidates() {
		UnityEngine.Profiling.Profiler.BeginSample("Create Candidates");
	...
	void PopulateCellCandidates() {
		UnityEngine.Profiling.Profiler.BeginSample("Populate Candidates");
		...
		for(int cellIdx = 0; cellIdx < m_phatCells.Count; ) {
			UnityEngine.Profiling.Profiler.BeginSample("Cell");
			...
			foreach(var pj in phatCell.pjobs) {
				UnityEngine.Profiling.Profiler.BeginSample("Paintjob");
